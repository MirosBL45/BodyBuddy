...
import { dejanUser, dejanPlans } from '@/constants/usersProgramsFull';
...
export default function ProfilePagePreview() {
  const user = dejanUser;
  const allPlans = dejanPlans;
          ...
          {currentPlan && (
            <div className="relative backdrop-blur-sm border border-border rounded-lg p-6">
              ...
              <Tabs defaultValue="workout" className="w-full">
                <TabsList className="mb-6 w-full flex flex-wrap justify-center gap-4 bg-cyber-terminal-bg border">
                  <TabsTrigger
                    value="workout"
                    className="data-[state=active]:bg-primary/20 data-[state=active]:text-primary flex items-center"
                  >
